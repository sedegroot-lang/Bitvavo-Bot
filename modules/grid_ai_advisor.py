...
class AIGridAdvisor:
    ...
    def _save_cache(self):
        ...
        try:
            ...
            write_json_compat(self.CACHE_FILE, {
                'timestamp': time.time(),
                'analyses': self._cache
            }, indent=2)
        except Exception as e:
    ...
    def get_top_grid_candidates(
        ...
        if markets is None:
            ...
            markets = [
                ...
                'ATOM-EUR', 'UNI-EUR', 'LTC-EUR', 'BCH-EUR', 'NEAR-EUR'
            ]
    ...
    def create_grid_plan(
        ...
        safety_limits = {
            ...
            'take_profit_pct': 0.10 if risk_profile == 'conservative' else (0.15 if risk_profile == 'balanced' else 0.25),
        ...
        log(f"[AIGridAdvisor] Created grid plan for {market}: "
    ...
    def get_grid_recommendations_summary(self, top_n: int = 5) -> Dict[str, Any]:
        ...
        for analysis in candidates:
            summary['candidates'].append({
                ...
                'volatility_7d': analysis.volatility_7d,
                'trend': 'up' if analysis.trend_strength > 0.1 else ('down' if analysis.trend_strength < -0.1 else 'neutral'),
                'trend_strength': analysis.trend_strength,
            })
