...
class QLearningAgent:
    ...
    def __init__(self, learning_rate: float = 0.1, discount_factor: float = 0.95,
                 epsilon: float = 0.1, state_file: str = "models/q_table.json",
...
class RewardCalculator:
    ...
    @staticmethod
    def calculate_trade_reward(pnl_pct: float, hold_hours: float, 
                               risk_adjusted: bool = True) -> float:
        """
...
class AdaptiveTradingAgent:
    ...
    def learn_from_trade(self, entry_state: Dict, action: str, 
                        exit_state: Dict, pnl_pct: float, hold_hours: float):
        """
