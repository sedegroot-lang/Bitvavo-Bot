...
class WebSocketClient:
    ...
    def __init__(
        self, markets: List[str], use_mock: bool = False, on_price_update: Optional[Callable[[str, float], None]] = None
    ):
    ...
    def _on_open(self, ws) -> None:
        ...
        for market in self.markets:
            subscribe_msg = {"action": "subscribe", "channels": [{"name": "ticker", "markets": [market]}]}
...
def get_websocket_client(
    markets: Optional[List[str]] = None, use_mock: bool = False, force_new: bool = False
) -> WebSocketClient:
